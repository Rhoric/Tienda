    ...
    <div class="row">
      ...
      <div class="col-lg-9">
          <div class="busqueda-searchbar">
              <form method="GET" action="GetProductListPublished" id="searchbar-id">
                  
                  <input type="text" class="form-control input-lg"style="max-width: 500px;" name="search" id="id-busqueda-buscar-input" placeholder="¿qué estás buscando?">
                  <br><div class="row" style="padding-left:5px;">
                      <div class="col"  style="max-width: 190px; padding-right:0px;">
                          <label for="dateStartId" class="signup-labels">Fecha inicial</label>
                          <input type="date" name="dateStart" id="dateStartId" class="form-control">
                      </div>
                      <div class="col"  style="max-width: 190px; padding-right:0px;">
                          <label for="dateEndId" class="signup-labels">Fecha final</label>
                          <input type="date" name="dateEnd" id="dateEndId" class="form-control">
                      </div>
                  
                  <!--<i class="fas fa-search" id="id-busqueda-buscar-i"></i>-->
                  <div class="col"><label for="filtroId" class="signup-labels">Filtro</label>
                  <select name="filtering" class="form-control" id="filtroId" style="max-width: 150px;">
                      <option value="none" selected>Ninguno</option>
                      <option value="Busquedas">Busquedas</option>
                  ...
                  <div class="col">
                      ...
                      <input type="submit" id="BuscarId"name="Subir" class="btn btn-primary btn-lg" value="Buscar">
                  </div>
                  </div>
              </form>
          </div>
